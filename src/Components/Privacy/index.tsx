...
export default function Privacy() {
  return (
    <>
      <section>
        <div className="privacy_headline">
          <h1>Privacy Policy</h1>
        </div>
        <div className="privacy_text">
          <br />
          <p>
            This Privacy Policy governs the manner in which TikTok Video
            Downloader collects, uses, maintains and discloses information
            collected from users (each, a "User") of the https://musicaldown.com
            website ("Site"). This privacy policy applies to the Site and all
            products and services offered by TikTok Video Downloader.
          </p>
          <br />
          ...
          <p>MusicalDown.com does not collect or store your data, period.</p>
          <br />
          ...
          <p>
            TikTok Video Downloader has the discretion to update this privacy
            policy at any time. When we do, we will revise the updated date at
            the bottom of this page and send you an email. We encourage Users to
          ...
          <br />
          <h1>Our privacy policy Changes</h1>
          <p>
            We Recommend to our Users to check this page for any changes to stay
            informed about how we are helping to protect the personal
            information we collect.
          </p>
          <br />
          <h1>Your acceptance to our Privacy Policy</h1>
          <p>By using snaptiktokyou are ACCEPTING our Terms & Policies.</p>
        </div>
      </section>
    </>
  );
